...
const dataTable = {
  headerRow: ["Player Name", "Player Email", "Booked Activity", "Party Size","Sport", "Actions"],
  footerRow: ["Player Name", "Player Email", "Booked Activity", "Party Size","Sport" ,"Actions"],
  dataRows: [
    {id:1234,clubid:'TEST.CLUB.ID',time:1234,username:'testname',useremail:'testemail',playerno:3, sport:'testsport'}
  ]
};
